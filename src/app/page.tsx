...
export default function LandingPage() {
  ...
  <div id="features" data-section="features">
      ...
      features={[
        {
          title: "Guaranteed University Acceptance",          description: "Customized guidance to match your academic profile with elite European institutions.",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3C9C4Q08C8xD7UAbWKXOEVzQwpC/uploaded-1775789344555-icvduoa7.jpg",          titleIconSrc: "http://img.b2bpic.net/free-photo/minimalist-illustration-monument_23-2151902644.jpg",          buttonText: "Explore"},
        {
          title: "Fast-Track Visa Processing",          description: "Seamless handling of visa applications and documentation to ensure 100% compliance.",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3C9C4Q08C8xD7UAbWKXOEVzQwpC/uploaded-1775789344555-qswhpu3u.jpg?_wi=1",          titleIconSrc: "http://img.b2bpic.net/free-photo/visa-application-form-smartphone_23-2149117803.jpg",          buttonText: "Learn More"},
        {
